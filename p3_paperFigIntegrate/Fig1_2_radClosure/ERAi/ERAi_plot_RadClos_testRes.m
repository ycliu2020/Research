...
% LastEditTime : 2021-04-17 19:09:28
% LastEditors  : Please set LastEditors
% Description  : plot radClos
% FilePath     : /code/p3_paperFigIntegrate/Fig1_2_radClosure/ERAi/ERAi_plot_RadClos_testRes.m
%
%%---------------------------------------------------------
clc; clear;
...
for exmNum = 1:1 % only 2000.03-2018.02
    ...
    %% plot
    figureTitle = {'Radiation closure experiment (90N-90S mean)', ['Radiation closure experiment (',dataArea,' mean)']};
    for areaNum = 2:2 % 1 Mean world 2 mean china
        ...
        for waveProp = 1:3 % total, short,long
            ...
            for sfcToa = 1:2 % sfc and toa
                ...
                plot(time, zeroLine', 'k--', 'LineWidth', 1)
        ...
        sgtitle({figureTitle{areaNum}, 'Data: ERAi'}, 'FontName', 'Microsoft YaHei', 'Fontsize', 18);

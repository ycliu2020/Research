...
% LastEditTime : 2021-04-21 20:18:53
% LastEditors  : Please set LastEditors
% Description  : cal china(CN) and world(UN-90-90) areamean rad and kernel cal rad 时间序列
%                注意辐射闭合检查值只适合晴空的情况
%                时间序列: 2000.03-2018-02
% FilePath     : /code/p3_paperFigIntegrate/Fig1_2_radClosure/ERA5_dRAreaMean_200003_201802.m
%
%%---------------------------------------------------------
clc; clear; tic;
% constant
...
for exmNum = 1:1 % only read 2000.03-2018.02 to cut to 2000.03-2014-02
    ...
    radEffectPath = fullfile(obsPath, tLin.time{exmNum}, 'ERA5', level.standVarPath{7}); %5: radEffect 7: radEffect/nodp
    %% load data
    % 观测值

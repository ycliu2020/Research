...
% LastEditTime : 2021-06-23 21:21:34
% LastEditors  : Please set LastEditors
% Description  : MME result of 时间序列图
% FilePath     : /code/p3_paperFigIntegrate/Fig3_timeSeries_tsVsRheatingRad/s1_regnGlb_MME_rhsE1_v3.m
...
function [] = plotPart(exmNum, timeType, time_plot, varUsed_plot, cc_weightMean, sizeLon, sizeLat, sizeTime, sizeVar, sizeRegion, sizeData)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %% plot Part
    radName = {['d', '\itRH', '\rm cc='], ['-', '\itK', '\rm_{Ts}', '\cdot\Delta', '\itT', '\rm_s'], ['-\Delta\itTHF','\rm+\itRes']};
    unitName = {'W m^{-2}'};
    dataName = {'ERA5', 'AMIP'};

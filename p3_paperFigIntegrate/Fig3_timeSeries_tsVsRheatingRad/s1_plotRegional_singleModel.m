...
% LastEditTime : 2021-05-09 22:55:27
% LastEditors  : Please set LastEditors
% Description  : MME result of 时间序列图
% FilePath     : /code/p3_paperFigIntegrate/Fig3_timeSeries_tsVsRheatingRad/s1_plotRegional_singleModel.m
...
for exmNum = 2:2 %1 mean amip 2000; 2 mean amip 1980;3 means ssp245, 4 means ssp370; 5 mean amip-hist 2000; 6 mean amip-hist 1980
    ...
    for mdlNum = 1:length(level.model2)
        ...
        for esmNum = specificNum:specificNum %1:length(esmName)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %% save Part
            outPutPath = fullfile('/home/liuyc/Research/P02.Ts_change_research/figOfPaper/v0.3/');

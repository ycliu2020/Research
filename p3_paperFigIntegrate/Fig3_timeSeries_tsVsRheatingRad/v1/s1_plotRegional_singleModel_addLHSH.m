...
% LastEditTime : 2021-04-20 22:36:36
% LastEditors  : Please set LastEditors
% Description  : MME result of 时间序列图
% FilePath     : /code/p3_paperFigIntegrate/Fig3_timeSeries_tsVsRheatingRad/s1_plotRegional_singleModel_addLHSH.m
...
for exmNum = 2:2 %1 mean amip 2000; 2 mean amip 1980;3 means ssp245, 4 means ssp370; 5 mean amip-hist 2000; 6 mean amip-hist 1980
    ...
    varibalCode = {'dlwUPMask', 'drhsMask', 'dlwUPRawDataMask'};
    ...
    for mdlNum = 1:length(level.model2)
        ...
        for esmNum = specificNum:specificNum %1:length(esmName)
            ...
            varUsed(:,:,:,2,:,2)=varUsed(:,:,:,2,:,2)-varUsed(:,:,:,4,:,2)-varUsed(:,:,:,5,:,2);
            ...
            unitName = {'W m^{-2}'};
            dataName = {'ERA5', level.model2{mdlNum}};

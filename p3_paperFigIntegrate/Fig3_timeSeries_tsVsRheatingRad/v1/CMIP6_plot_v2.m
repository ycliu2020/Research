...
for exmNum = 1:1%1 mean amip 2000; 2 mean amip 1980;3 means ssp245, 4 means ssp370; 5 mean amip-hist 2000; 6 mean amip-hist 1980
    ...
    for mdlNum = 3:3%1:length(level.model2)
        ...
        for esmNum = specificNum:specificNum%1:length(esmName)
            ...
            load([dradEffectPath, 'model_dradEffect.mat'])% 'dR_net_cld', 'l_rad', 's_rad', 'dR_clr', 'readme_realradEffect'
            ...
            if exmNum == 1
                ...
                title_txt = {['Level:', num2str(toaSfc{2}), ', Era: 198003-201402'], ['Model:', level.model2{mdlNum} ', Ensemble: ', esmName{esmNum}], ['90N-90S land, global mean'],[]};

...
% LastEditTime : 2021-05-13 16:34:03
% LastEditors  : Please set LastEditors
% Description  :
% FilePath     : /code/p2_processCMIP6Data/s2.radEffTrend/contribAnalysis/MME_cntAls_joint_addSFCLay.m
%
%%---------------------------------------------------------
clc; clear;
nowpath = pwd;
...
for exmNum = exmStart:exmEnd
    ...
    for areaNum = 1:length(areaStr)
        [lineStart] = calCovContribution(latRange, lat_f, timeType, ntime, MMEType, areaStr, areaNum, dTs_x_sfc, outPutFile, lineStart);
    end
...
function [lineStart] = calCovContribution(latRange, lat_f, timeType, ntime, MMEType, areaStr, areaNum, dTs_x_sfc, outPutFile, lineStart)

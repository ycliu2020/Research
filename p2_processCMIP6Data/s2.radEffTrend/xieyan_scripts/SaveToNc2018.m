...
for ii = 1:2
    for jj = 1:2
        ...
        filename_vari = strcat('/data1/xieyan/ERAi/eraiRadAnom_2018',upper(var),var2,'sky.nc');
        filename_ceres = strcat('/data1/xieyan/CERES_EBAF/ceresAnom',upper(var),'.nc');
%         filename_erai = '/data1/xieyan/ERAi/Rad_ori/ERAi_radAnom.nc';
        filename_ceres1 = strcat('/data1/xieyan/CERES_EBAF/ceresAnomclr',upper(var),'.nc');  % EBAF for clear-sky
...
%         filename = strcat('/data1/xieyan/',var,'_',var2,'.nc');
        filename = strcat('/data1/xieyan/EBAF_clear/',var,'_',var2,'.nc');

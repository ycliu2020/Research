...
% LastEditTime : 2020-11-18 19:22:18
% LastEditors  : LYC
...
for exmNum = 1:4%1 mean amip 2000; 2 mean amip 1980;3 means ssp245, 4 means ssp370; 5 mean amip-hist 2000; 6 mean amip-hist 1980
    ...
    mPath.uniOutput1 = fullfile('/home/liuyc/Research/P02.Ts_change_research/figure/proj2_cmip6Result/TimeSeries_analysis/v0.2/landMean_RadEffectAll', level.time1{exmNum}); %['dRTs_', lower(mlabels.level)],
    mPath.uniOutput2 = fullfile('/home/liuyc/Research/P02.Ts_change_research/figure/proj2_cmip6Result/TimeSeries_analysis/v0.2/timeCC_globalDistribution', level.time1{exmNum}); %['dRTs_', lower(mlabels.level)],

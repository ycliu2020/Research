...
# function [lon_f,lat_f,cc_global,headLineTxt,figPath,colorLab] = Pyn_figure1_2(exmNum, MMEType)
figData = eng.amipAndERA5CC_glbTS(MMEType, ERAType, nargout=6)
...
plotData = figData[2]
plotData = np.squeeze(np.array(plotData)[:, :, 1, :])

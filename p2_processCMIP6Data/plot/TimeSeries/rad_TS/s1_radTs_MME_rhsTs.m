...
% LastEditTime : 2021-05-09 21:46:09
% LastEditors  : Please set LastEditors
% Description  : 同时画时间序列和相关性分布图
% FilePath     : /code/p2_processCMIP6Data/plot/radTimeSeries/s1_radTs_MME_rhsTs.m
%
%%---------------------------------------------------------
clc; clear; tic;
nowpath = pwd;
...
for exmNum = 1:1 %1 mean amip 2000; 2 mean amip 1980;3 means ssp245, 4 means ssp370; 5 mean amip-hist 2000; 6 mean amip-hist 1980
    ...
    varibalCode = {'dR_tsMask', 'drhsMask', 'dR_taMask', ...
                    ...
                    'dhfssMask', 'dhflsMask','drhsKernMask'};
    ...
    varUsed(:, :, :, 5, :) = varUsed(:, :, :, 9, :) - varUsed(:, :, :, 2, :);% dR_ts-drhs

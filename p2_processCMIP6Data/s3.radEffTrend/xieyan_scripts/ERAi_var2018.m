...
plevf = ncread('/gs/project/ktg-565-aa/xxtan/data/kernel/rrtmgkernel/old/kernel-nodp/toa/RRTMG_wv_toa_cld_nodp.nc','p');
...
[Anom_q,Clim_q] = monthlyAnomaly4D(144,73,19,time,q);
[Anom_t,Clim_t] = monthlyAnomaly4D(144,73,19,time,t);

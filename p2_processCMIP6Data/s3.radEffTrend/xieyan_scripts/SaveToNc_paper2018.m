...
%% 1:Radiation Anomaly
ncid = netcdf.create('/data1/xieyan/datasets_radAnom2018.nc','NC_WRITE');
...
ncid = netcdf.create('/data1/xieyan/datasets_radTrend2018.nc','NC_WRITE');
...
ncid = netcdf.create('/data1/xieyan/datasets_radAnom2018_supp.nc','NC_WRITE');
...
ncid = netcdf.create('/data1/xieyan/datasets_radTrend2018supp.nc','NC_WRITE');

...
% LastEditTime : 2020-06-15 20:29:46
% LastEditors  : LYC
% Description  :
% FilePath     : /code/p2_processCMIP6Data/s99.plot/s2_plot_nonLocalCld_dRTrend.m
%
%%---------------------------------------------------------
...
[mlabels, areaNum] = plotParameters('sfc', 'land', 'nonLocalCld_rad'); % plot parameters mlabels.level(SFC/TOA)

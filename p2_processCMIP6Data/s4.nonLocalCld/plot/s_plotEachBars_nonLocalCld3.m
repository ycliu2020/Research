...
% LastEditTime : 2020-09-23 15:02:35
% LastEditors  : LYC
% Description  : only cal ensember r1i1p1f1
% FilePath     : /code/p2_processCMIP6Data/s4.nonLocalCld/plot/s_plotEachBars_nonLocalCld3.m
%
%%---------------------------------------------------------
...
for exmNum = exm_left:exm_right
    ...
    mPath.uniOutput = fullfile('/home/liuyc/Research/P02.Ts_change_research/figure/02.cmip6Result/nonLocalCld3/', level.time1{exmNum}); %['dRTs_', lower(mlabels.level)],

...
% file structure
% set time parameter
for p_1 = 5:5%1 mean amip 2000; 2 mean amip 1980;3 means ssp245, 4 means ssp370; 5 4xCO2, 6 mean amip-hist 2000; 6 mean amip-hist 1980
    % model parameters
    ...
    for level1 = 1:length(level.model2)% model number
        ...
        %% check Time line , read first time and last 150 years is ok. 
        % locate first year
        ...
        % read variables
            ...
            if ismember(1, strcmp(v_names{ii}, vars.D4))% 4D vars
                ...
                clear temp_v Xlon Ylat Zplev Ttime Xlonf Ylatf Zplevf Ttimef
            ...
            save([outPathName{1}, v_names{ii}], v_names{ii}, '-v7.3');
            ...
            save([outPathName{2}, dv_names{ii}], dv_names{ii}, clim_v_names{ii}, '-v7.3');

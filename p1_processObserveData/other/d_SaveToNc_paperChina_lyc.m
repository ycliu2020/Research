%% datasets
% modify output and input path first
clear
pre_load;
...
input = '/home/lyc/repeat_Kernel_experiment/testdata/EBAF_clear/';
output = '/home/lyc/repeat_Kernel_experiment/testdata/';
filename1 = [input,'sfc_all.nc'];
    ...
    for ii = 1:2
        for zz = 1:2
            for jj = 1:3
                ...
                filename = strcat(input,var,'_',var3,'.nc');
...
ncid = netcdf.create([output,'Trendrad_China.nc'],'NC_WRITE');
...
ncid = netcdf.create([output,'Trendrad_Chinasupp.nc'],'NC_WRITE');
%Define the dimensions
dimidlon = netcdf.defDim(ncid,'longitude',nlonf);
dimidlat = netcdf.defDim(ncid,'latitude',nlatf);
dimidmonth = netcdf.defDim(ncid,'month',12);

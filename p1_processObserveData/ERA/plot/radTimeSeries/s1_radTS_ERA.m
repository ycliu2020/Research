...
% Description  :
% FilePath     : /code/p1_processObserveData/ERA/plot/radTimeSeries/s1_radTS_ERA.m
%
%%---------------------------------------------------------
...
for exmNum = 5:5 % '200003-201802', '200207-201706', '200003-201402', '200001-201412', '198001-201412', '200003-202011'
    ...
    % varUsed(:, :, :, 5, :)=varUsed(:, :, :, 5, :)+varUsed(:, :, :, 7, :)+varUsed(:, :, :, 8, :)+varUsed(:,:,:,6,:);%+varUsed(:, :, :, 7, :)+varUsed(:, :, :, 8, :)+(-varUsed(:,:,:,1,:)+varUsed(:,:,:,2,:)+varUsed(:,:,:,3,:)+varUsed(:,:,:,4,:)+varUsed(:,:,:,6,:))
    sizeVar = 6;
    % global annual mean

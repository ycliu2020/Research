...
%modify path first
filepath = '/data1/xieyan/ERAi/Rad_ori/';
testpath= '/home/lyc/repeat_Kernel_experiment/testdata/ERAi/';
%creat 19yrs to cal
...
dR_lw_toa_all = dR_lw_toa_all0(:,:,3:218); 
dR_sw_toa_all = dR_sw_toa_all0(:,:,3:218); 
dR_lw_sfc_all = dR_lw_sfc_all0(:,:,3:218); 
dR_sw_sfc_all = dR_sw_sfc_all0(:,:,3:218); 
time = time0(3:218,1);
...
% Deseasonalized(即变量减去平均值)
[dR_lw_toa_all,ClimdR_lw_toa_all] = monthlyAnomaly3D(144,72,time,dR_lw_toa_all);
[dR_sw_toa_all,ClimdR_sw_toa_all] = monthlyAnomaly3D(144,72,time,dR_sw_toa_all);
[dR_lw_sfc_all,ClimdR_lw_sfc_all] = monthlyAnomaly3D(144,72,time,dR_lw_sfc_all);
[dR_sw_sfc_all,ClimdR_sw_sfc_all] = monthlyAnomaly3D(144,72,time,dR_sw_sfc_all);
month = 1:12;

%% Save to nc
saveto = strcat(testpath,'ERAi_radAnom_all_r.nc');
...
dR_lw_toa_clr_ID = netcdf.defVar(ncid,'dR_lw_toa_all','double',[dimidlon dimidlat dimidtime]);
dR_sw_toa_clr_ID = netcdf.defVar(ncid,'dR_sw_toa_all','double',[dimidlon dimidlat dimidtime]);
dR_lw_sfc_clr_ID = netcdf.defVar(ncid,'dR_lw_sfc_all','double',[dimidlon dimidlat dimidtime]);
dR_sw_sfc_clr_ID = netcdf.defVar(ncid,'dR_sw_sfc_all','double',[dimidlon dimidlat dimidtime]);

ClimdR_lw_toa_clr_ID = netcdf.defVar(ncid,'ClimdR_lw_toa_all','double',[dimidlon dimidlat dimidmonth]);
ClimdR_sw_toa_clr_ID = netcdf.defVar(ncid,'ClimdR_sw_toa_all','double',[dimidlon dimidlat dimidmonth]);
ClimdR_lw_sfc_clr_ID = netcdf.defVar(ncid,'ClimdR_lw_sfc_all','double',[dimidlon dimidlat dimidmonth]);
ClimdR_sw_sfc_clr_ID = netcdf.defVar(ncid,'ClimdR_sw_sfc_all','double',[dimidlon dimidlat dimidmonth]);
%Define units for the main variables
netcdf.putAtt(ncid, dR_lw_toa_clr_ID,'long_name','Radiation Anomaly (lw) at TOA');
netcdf.putAtt(ncid, dR_lw_toa_clr_ID,'units', 'W m**-2');
netcdf.putAtt(ncid, dR_sw_toa_clr_ID,'long_name','Radiation Anomaly (sw) at TOA');
netcdf.putAtt(ncid, dR_sw_toa_clr_ID,'units', 'W m**-2');
netcdf.putAtt(ncid,dR_lw_sfc_clr_ID,'long_name','Radiation Anomaly (lw) at SFC');
netcdf.putAtt(ncid,dR_lw_sfc_clr_ID,'units', 'W m**-2');
netcdf.putAtt(ncid,dR_sw_sfc_clr_ID,'long_name','Radiation Anomaly (sw) at SFC');
netcdf.putAtt(ncid,dR_sw_sfc_clr_ID,'units', 'W m**-2');

netcdf.putAtt(ncid, ClimdR_lw_toa_clr_ID,'long_name','Radiation Climatology (lw) at TOA');
netcdf.putAtt(ncid, ClimdR_lw_toa_clr_ID,'units', 'W m**-2');
netcdf.putAtt(ncid, ClimdR_sw_toa_clr_ID,'long_name','Radiation Climatology (sw) at TOA');
netcdf.putAtt(ncid, ClimdR_sw_toa_clr_ID,'units', 'W m**-2');
netcdf.putAtt(ncid,ClimdR_lw_sfc_clr_ID,'long_name','Radiation Climatology (lw) at SFC');
netcdf.putAtt(ncid,ClimdR_lw_sfc_clr_ID,'units', 'W m**-2');
netcdf.putAtt(ncid,ClimdR_sw_sfc_clr_ID,'long_name','Radiation Climatology (sw) at SFC');
...
netcdf.putVar(ncid,dR_lw_toa_clr_ID,dR_lw_toa_all);
netcdf.putVar(ncid,dR_sw_toa_clr_ID,dR_sw_toa_all);
netcdf.putVar(ncid,dR_lw_sfc_clr_ID,dR_lw_sfc_all);
netcdf.putVar(ncid,dR_sw_sfc_clr_ID,dR_sw_sfc_all);

netcdf.putVar(ncid,ClimdR_lw_toa_clr_ID,ClimdR_lw_toa_all);
netcdf.putVar(ncid,ClimdR_sw_toa_clr_ID,ClimdR_sw_toa_all);
netcdf.putVar(ncid,ClimdR_lw_sfc_clr_ID,ClimdR_lw_sfc_all);
netcdf.putVar(ncid,ClimdR_sw_sfc_clr_ID,ClimdR_sw_sfc_all);

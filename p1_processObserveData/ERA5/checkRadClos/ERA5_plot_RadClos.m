...
for p_1 = 1:2
    ...
    outPutPath = fullfile('/home/liuyc/Research/P02.Ts_change_research/figure/01.observe/1.3/', tLin.time{p_1}, 'ERA5', 'fig_radClos');
    ...
    for areaNum = 1:2% 1 Mean world 2 mean china
        ...
        figureName=['ERA5_', tLin.time{p_1}, '_',areaName{areaNum}, '_radClos'];

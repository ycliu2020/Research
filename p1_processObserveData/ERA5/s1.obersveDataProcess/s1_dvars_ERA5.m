...
% LastEditTime : 2020-07-06 13:22:15
% LastEditors  : LYC
...
% FilePath     : /code/p1_processObserveData/ERA5/s1.obersveDataProcess/s1_dvars_ERA5.m
%
%%---------------------------------------------------------
clc; clear; tic;
% constant
...
% 1.2 按时间划分文件的变量
for yearNum = 0:1% (read raw range: 2000-2018)
    % meto data
...
plev_k1 = ncread('/data1/liuyincheng/y_kernels/kernels_YiH/toa/dp.nc', 'player'); % player 最大1000符合条件pay attention to plev_k's range must smaller than plev_ori's
plev_k = plev_k1(end:-1:1); % 调整kernel坐标使得和ERA5的垂直方向一致(方便差值)

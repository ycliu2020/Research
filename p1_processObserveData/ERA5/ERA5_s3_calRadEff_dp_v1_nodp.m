...
% LastEditTime : 2021-04-14 15:53:09
% LastEditors  : Please set LastEditors
% Description  :
% FilePath     : /code/p1_processObserveData/ERA5/ERA5_s3_calRadEff_dp_v1_nodp.m
%
%%---------------------------------------------------------
clear; clc; tic;
% pause(9999)
...
for i = 1:2
    ...
    for j = 1:2
        n = n + 1;
        kernelsName{n} = ['kernels_', kernelsHightLabel{i}, '_', kernelsLevel2_sky{j}, '_nodp.mat'];
...
for p_1 = 1:1
    ...
    radEffectPath = fullfile('/data1/liuyincheng/Observe-process', tLin.time{p_1}, 'ERA5', level.standVarPath{7}); %'radEffect/nodp/'

...
% LastEditTime : 2021-04-13 21:13:04
...
for p_1 = 1:1
    ...
    for ii = 1:4%( 1sfc cld,2sfc clr,3toa cld,4toa clr)
        ...
        if ii <= 2
            ...
            save([radEffectPath, saveradEfectName{ii}], 'wvlwEffect', 'wvswEffect', 'tsEffect', 'albEffect', 'husEffect', ...
    ...
    save([radEffectPath, 'dradEffect_union.mat'], 'dR_hus', 'dR_alb', 'dR_ts', 'dR_ta', 'dR_total', 'readme_radEfect');
    ...
    save([radEffectPath, 'real_dradEffect.mat'], 'l_rad', 's_rad', 'dR_allsky', 'dR_clr', 'readme_realradEfect');
    ...
    save([radEffectPath, 'dR_cloud_sfc.mat'], 'dR_cloud_sfc');
    save([radEffectPath, 'dR_cloud_toa.mat'], 'dR_cloud_toa');
    ...
    save([radEffectPath, 'dR_ObsTotal.mat'], 'dR_ObsTotal_cld_sfc', 'dR_ObsTotal_cld_toa', ...
    ...
    save([radEffectPath, 'dR_mainEffect_sfc.mat'], 'dR_mainEffect_sfc');
    save([radEffectPath, 'dR_mainEffect_toa.mat'], 'dR_mainEffect_toa');

...
% LastEditTime : 2021-04-12 09:57:10
% LastEditors  : Please set LastEditors
% Description  :
% FilePath     : /code/p1_processObserveData/ERA5/checkHusAndRcloud/ERA5_s3_calRadEff_dp_v1_noSave.m
%
%%---------------------------------------------------------
clear; clc; tic;
% pause(9999)
...
for p_1 = 4:4
    ...
    dR_alb = dR_hus; dR_ts = dR_hus; dR_ta = dR_hus; dR_nonCloud = dR_hus; dR_main = dR_hus;
    ...
    for ii = 1:4%( 1sfc cld,2sfc clr,3toa cld,4toa clr)
        ...
        dR_ta(:, :, :, ii) = taEffect; % t
        dR_nonCloud(:, :, :, ii) = totalEffect; % total
    ...
    % save([radEfectPath, 'real_dradEffect.mat'], 'l_rad', 's_rad', 'dR_allsky', 'dR_clr', 'readme_realradEfect');
    ...
    %method 2
    dR_residual_clr = dR_clr - dR_nonCloud(:, :, :, [2 4]);
    dR_residual_cld = dR_allsky - dR_nonCloud(:, :, :, [1 3]) - dR_cloud; % r terms, indicate co2/aerosol forcing
    dR_residual_cld1 = dR_allsky - dR_nonCloud(:, :, :, [1 3]); % r terms, indicate cloud feedback and co2/aerosol forcing

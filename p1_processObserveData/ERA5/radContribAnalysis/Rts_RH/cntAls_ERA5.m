...
% LastEditTime : 2021-06-29 22:00:54
% LastEditors  : Please set LastEditors
% Description  :
% FilePath     : /code/p1_processObserveData/ERA5/radContribAnalysis/Rts_RH/cntAls_ERA5.m
...
% Path
ERA5Path = '/data2/liuyincheng/Observe-process/200001-201412/ERA5';
...
% % LH and SH
% dvarsPath = fullfile(exmPath, 'anomaly'); %anomaly
...
dTs_x_sfc(:, :, :, 2) = dTs_x_sfc(:, :, :, 1)-drhs - dhFlux; % or -squeeze(dR_allsky(:,:,:,1))+dR_residual_cld_sfc;
dTs_x_sfc(:, :, :, 3) = drhs;
dTs_x_sfc(:, :, :, 4) = dhFlux;

...
% LastEditTime : 2020-07-09 10:52:13
% LastEditors  : LYC
% Description  : cal china(CN) and world(UN-60-60) areamean rad and kernel cal rad 时间序列
%                注意辐射闭合检查值只适合晴空的情况
% FilePath     : /code/p1_processObserveData/ERAi/checkRadClos/ERAi_dRAreaMean.m
%
%%---------------------------------------------------------
clc; clear; tic;
% constant
...
for p_1 = 1:2
    ...
    trend_radEfectPath = fullfile('/data1/liuyincheng/Observe-process', tLin.time{p_1}, 'ERAi', level.standVarPath{6}); %/data1/liuyincheng/cmip6-proces/aimp_2000-2014/MRI-ESM2-0/ensemble/radEffect_trend/
    %% load data
    % 观测值

...
% LastEditTime : 2021-04-22 15:38:08
% LastEditors  : Please set LastEditors
% Description  :
% FilePath     : /code/p1_processObserveData/ERAi/ERAi_s3_calRadEff_dp_v2.m
%
% the change compared v1: fix hus error and unified name, consistent with the model
%%---------------------------------------------------------
clear; clc; tic;
% pause(9999)
%%% constant

...
unite = {' trend(K/10a)',' trend(W\cdotm-2/10a)', ...
    ' trend(W\cdotm-2/10a)',' trend(W\cdotm-2/10a)', ...
    ' trend(W\cdotm-2/10a)',' trend(W\cdotm-2/10a)', ...
    ' trend(W\cdotm-2/10a)',' trend(W\cdotm-2/10a)', ...
    ' trend(W\cdotm-2/10a)',' trend(W\cdotm-2/10a)', ...
    ' trend(W\cdotm-2/10a)',' trend(W\cdotm-2/10a)'};
component = {'Ts', 'RHeating(Ta+q+alb+cloud+Resi)', 'RHeating(Ta+q+alb+cld)', ...
    'RHeating(erai Rad)', '\DeltaR-K_T_s\DeltaT_s', 'RHeating(Ta+q+alb+cld+Resi(erai))', ...
    'Residual(modis)', 'Cloud radeffect(modis)', 'Ta radeffect', ...
    'Residual(eari)', 'q radeffect', 'albedo radeffect'};
component_label = {'dts', 'dRsfcHeat_varsCal_Resi', 'dRsfcHeat_varsCal_noResi', ...
    'drhs', 'testVar_equal_Resi', 'dRsfcHeat_varsCal_ResiERAi', ...
    'dRsfc_residualMOD', 'dRsfc_cloudMOD', 'dRsfc_ta', ...
    'dRsfc_residual', 'dRsfc_q', 'dRsfc_alb'};%dts
...
c = colorbar('southoutside', 'Position', [pos(1)-0.3 pos(2)-0.05 0.6 pos(4)/8]);
c.TickLength = 0.02;
% c.LineWidth = 2;
c.Limits = [mmin mmax];
% c.LineWidth = 'white';
